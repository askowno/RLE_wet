...
wet_results_vector <- wet_v %>%
  left_join(wet_results_for_integration, by = "type" )

st_write(
  wet_results_vector,
  "C:/Users/skownoa/Dropbox/NBAwork/Wetlands/wet_results_vector.gpkg",
  delete_dsn = TRUE
)
...
st_write(
  ...
  "C:/Users/skownoa/Dropbox/NBAwork/Wetlands/wet_results_vector_dd.gpkg",
  delete_dsn = TRUE
)
```
