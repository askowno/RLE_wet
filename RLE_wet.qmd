...
# Read PAs (projected layer) not required butmakes correcting proj easy
...
Using PESALL PESVEG PESWQ PESGEO PESHYD separately in a D3 assessment (this prevents the overall Wet Health score dominating the RLE) and allows us to see the symptom of decline more clearly

```{r}
# Calculate D2 based on rate of decline in PES score over period 2018-2024 projected forward to 2068, then assess % of decline over 50years - This would be much worse is we had real PES trends 
D2fin <- wet_tb %>%
    group_by(type) %>%
    summarise(across(
    c(call24 = PES22ALL,
